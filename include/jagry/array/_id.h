...
static JUnsignedInteger jAcquireArray( JIArray self ) { return jAcquireBase( self.super ) ; }
static JStatus jGetArrayInterface( JIArray self ) { return jAcquireBase((self).super); }
